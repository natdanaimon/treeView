! function() {
    ...
    function CnNAG(n, t, e, r) {
        ...
        return !this.XDomainRequest ||
            "withCredentials" in l || !/^(http(s)?:)?\/\//.test(n) ||
            (l = new XDomainRequest), "onload" in l ? l.onload = l.onerror = i : l.onreadystatechange =
            function() {
                i()
            }, u.header = function(n, t) {
               // return n = (n + "").toLowerCase(), arguments.length < 2 ? a[n] : (null == t ? delete a[n] : a[n] = t + "", u)
               ...
               // return arguments.length ? (c = n, u) : c
                ...
                debugger;
                if (2 === arguments.length && "function" == typeof r && (i = r, r = null), l.open(e, n, !0), null == t || "accept" in a || (a.accept = t + ",*/*"), l.setRequestHeader)
                    for (var f in a) l.setRequestHeader('accept', 'application/json,*/*');
    ...
    ec.year = ga.year.utc, ga.scale.utc = function() {
        ...
        return CnNAG(n, "application/json", uoNAG, t)
